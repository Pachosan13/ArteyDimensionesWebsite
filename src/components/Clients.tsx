  ...
  return (
    <section id="clientes" className="relative py-16 lg:py-24 overflow-hidden" aria-labelledby="clientes-title">
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(to bottom, rgba(15,15,15,0.4), rgba(15,15,15,0.7), rgba(15,15,15,0.8))',
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              {t.clients.headingPre} <span className="border-b-4 border-brand">{t.clients.headingHighlight}</span>
            </motion.h2>
                ...
                {clientLogos.map((client, index) => (
                  ...
                  >
                    <img
                      ...
                      alt={`${client.name} - ${t.clients.logoAltSuffix}`}
                      loading="lazy"
                      decoding="async"
