  ...
  return (
    <section id="mapa-panama" className="bg-[#F5F5F5] py-16 lg:py-24" aria-labelledby="mapa-panama-heading">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div
          className="grid gap-10 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1.2fr)] items-center"
          ref={containerRef}
        >
          <div>
            <h2
          ...
          <div className="relative overflow-hidden rounded-3xl bg-neutral-100 shadow-2xl">
            <div className="relative aspect-[5/3]">
              ...
              <div className="pointer-events-none absolute inset-0">
                {projects.map((project) => {
                  ...
                  return (
                    <button
                      ...
                      className="pointer-events-auto absolute z-10 -translate-x-1/2 -translate-y-1/2 h-5 w-5 rounded-full border-2 border-white bg-red-600 shadow-md transition-transform focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand hover:scale-110"
                ...
                {activeProject && (
                  <div
                    className="pointer-events-none absolute z-20 -translate-x-1/2 -translate-y-full max-w-[180px] rounded-lg bg-white px-3 py-2 text-xs text-gray-800 shadow-xl ring-1 ring-black/5 transition"
